...
%global commit d20e89649dd85fd59bef409363ba971c4fad54d5
...
%prep
%forgeautosetup -p1 -n anbox-%{commit}
...
# There exits bugs and thus we must build sdbus-cpp first
make sdbus-cpp
make -j
